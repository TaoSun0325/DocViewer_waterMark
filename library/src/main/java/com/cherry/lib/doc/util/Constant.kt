...
object Constant {
    ...
    const val INTENT_WATER_LABELS = "INTENT_WATER_LABELS"
    const val INTENT_WATER_DEGRESS = "INTENT_WATER_DEGRESS"
    const val INTENT_WATER_FONT_SIZE = "INTENT_WATER_FONT_SIZE"
    const val INTENT_WATER_FONT_COLOR = "INTENT_WATER_FONT_COLOR"
